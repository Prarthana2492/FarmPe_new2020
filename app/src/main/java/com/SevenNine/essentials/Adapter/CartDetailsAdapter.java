...
public class CartDetailsAdapter extends RecyclerView.Adapter<CartDetailsAdapter.MyViewHolder>  {
  //  private List<OrderDetailBean> productList;
    private List<Cart_Bean> productList;
    Activity activity;
    ...
    public CartDetailsAdapter(Activity activity, List<Cart_Bean> moviesList) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        final Cart_Bean products1 = productList.get(position);

        holder.prod_name.setText(products1.getProd_name());
        holder.amount.setText("₹ " + products1.getCost());
        holder.mrp.setText("₹ " + products1.getMrp());
        holder.quantity.setText("Quantity: "+products1.getQuantity());
        holder.shipping_fee.setText("Delivery Charges: "+ products1.getDelivery_charges());
        holder.shipping_iscount.setText("save: " + products1.getSave_amount());
...
/*if (position==(productList.size()-1)){
    holder.view_line.setVisibility(View.GONE);
        ...
        Glide.with(activity).load(products1.getProduct_image())
                .thumbnail(0.5f)
                // .crossFade()
