...
public class Home_Page_List_Adapter extends RecyclerView.Adapter<Home_Page_List_Adapter.MyViewHolder> {
    ...
    public Home_Page_List_Adapter(Activity activity, List<MainVerticalBean> moviesList) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                ...
                .inflate(R.layout.shop_cat2, parent, false);
