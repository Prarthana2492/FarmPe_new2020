...
import com.SevenNine.essentials.Fragment.ProductDetailsPreviewFragment;
...
public class CategoryProdDetailAdapter extends RecyclerView.Adapter<CategoryProdDetailAdapter.MyViewHolder> {
    ...
    public CategoryProdDetailAdapter(Activity activity, List<Sellbean1> moviesList) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
     final Sellbean1 products = productList.get(position);
      sellingtypeid=products.getId();
        holder.name.setText(products.getName()+", "+" - "+ "200g");
...
//        if (products.getActual_price().equals("0")){
...
//            holder.price.setText("Rs "+products.getActual_price());
